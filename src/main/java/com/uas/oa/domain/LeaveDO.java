...
public class LeaveDO implements Serializable {
	 ...
	 * 设置：通知人
	 */
	public void setLvNotifier(String lvNotifier) {
		this.lvNotifier = lvNotifier;
	}
	/**
	 * 获取：通知人
	 */
	public String getLvNotifier() {
		return lvNotifier;
	}
	/**
	 * 设置：附件
	 */
	public void setLvFiles(String lvFiles) {
		this.lvFiles = lvFiles;
	}
	/**
	 * 获取：附件
	 */
	public String getLvFiles() {
		return lvFiles;
	}
}
